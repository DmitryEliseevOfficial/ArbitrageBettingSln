    ...
    public static class RandomPassword
    {
        ...
        public static void SetParams(bool numbers, bool lcase, bool ucase, bool special)
        {
            ...
            if (ucase == false)
                _passwordCharsUcase = "";
            if (special == false)
                _passwordCharsSpecial = "";
        }

        public static void Restore()
        {
            _passwordCharsLcase = "abcdefgijkmnopqrstwxyz";
                                      ...
                                      int maxLength)
        {
            ...
            if (_passwordCharsLcase != "")
                charGroups.Add(_passwordCharsLcase.ToCharArray().ToList());
            if (_passwordCharsUcase != "")
                charGroups.Add(_passwordCharsUcase.ToCharArray().ToList());
            if (_passwordCharsNumeric != "")
                charGroups.Add(_passwordCharsNumeric.ToCharArray().ToList());
            if (_passwordCharsSpecial != "")
                charGroups.Add(_passwordCharsSpecial.ToCharArray().ToList());
            ...
            for (int i = 0; i < charsLeftInGroup.Length; i++)
                charsLeftInGroup[i] = charGroups[i].Count;
